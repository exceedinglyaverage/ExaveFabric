...
public enum ModArmorMaterial implements ArmorMaterial {
    ...
    }), 12, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 1.0f, 0.0f, () -> Ingredient.ofItems(ModItems.BRONZE_INGOT)),
    STEEL("steel", 25, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
    ...
    public String getName() {
        return ExaveCraft.MOD_ID +":"+this.name;
    }
